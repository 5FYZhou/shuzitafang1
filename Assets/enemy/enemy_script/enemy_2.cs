...
public class enemy_2 : MonoBehaviour, IHealthAccessor, enemy
{
    ...
    public void Start()
    {
        ...
        HP = new float[] { 55f, 55f };

        attack_interval = new float[] { 0.5f, 1f, 0 };
        ...
        fission_range = new float[] { 0.01f, 0.2f };//按占格子的百分比来
        ...
        enemy_2_animation.SetBool("death", death);
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        if (other.gameObject.CompareTag("tower"))
        {
            ...
            enemy_2_animation.Play("enemy_2_attack", -1, 0f);
